...
> **Note:** AI/RAG components are currently a foundation for the major-project extension; not every planned AI feature is exposed as a production API yet.
...
| Event APIs | ✅ Implemented |
| Registration APIs | ✅ Implemented |
| Venue APIs | ✅ Implemented |
| Payment APIs | ✅ Implemented |
| Feedback APIs | ✅ Implemented |
| Admin dashboard | ✅ Implemented |
| Admin authentication | ✅ Implemented |
| Admin Events integration | ✅ Connected |
| Admin Users integration | ✅ Connected |
| Admin Dashboard metrics | ✅ Connected |
| Admin Registration integration | 🟡 Partial |
| RAG foundation | 🟡 In development |
| Vector database | 🔮 Planned |
| LLM integration | 🔮 Planned |
| Agentic workflows | 🔮 Planned |
| AI recommendations | 🔮 Planned |
| Advanced reports | 🔮 Planned |
| Admin calendar backend | 🔮 Planned |
| Admin settings backend | 🔮 Planned |

**Legend:** ✅ Implemented · 🟡 In progress/partial · 🔮 Planned

---

# 🗺️ Major Project Roadmap
